...
def get_pick_place_eval_dirs(args):
    ...
    if args.pi == 'soap':
        ...
        eval_dir = "/data/public/rw/pass.port/NAMO/n_data_" + str(
            n_data) + "/soap/adv/tau_2.0/dg_lr_0.0001_0.0001/n_score_1/architecture_1/explr_const_0.5/"
    elif args.pi == 'ddpg':
        pick_dir = "/data/public/rw/pass.port/NAMO/n_data_" + str(n_data) + \
        ...
        pick_dir = "/data/public/rw/pass.port/NAMO/n_data_" + str(
            n_data) + "/trpo/adv/tau_0.3/dg_lr_0.0001_0.0001/n_score_1/architecture_0/"
        place_dir = "/data/public/rw/pass.port/NAMO/n_data_" + str(
            n_data) + "/trpo/adv/tau_0.3/dg_lr_0.0001_0.0001/n_score_1/architecture_0/"
        eval_dir = pick_dir + '/explr_const_0.5/'
    elif args.pi == 'gail':
        pick_dir = "/data/public/rw/pass.port/NAMO/n_data_" + str(
            n_data) + "/gail/adv/tau_0.3/dg_lr_0.0001_0.0001/n_score_1/architecture_0/"
        place_dir = "/data/public/rw/pass.port/NAMO/n_data_" + str(
            n_data) + "/gail/adv/tau_0.3/dg_lr_0.0001_0.0001/n_score_1/architecture_0/"
        eval_dir = pick_dir + '/explr_const_0.5/'
    else:
